...
class Parser
{
    ...
    private Expr ternary() // grammar rule ternary --> or "?" or ":" ternary, Notice the beauty : left recursive rules dont work in a recursive descent parser, but right recusive does ! and ternary is right associative which is implemented by a right recursive rule.
    {
       Expr expr = or();
